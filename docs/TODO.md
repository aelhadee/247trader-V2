...
- [x] Adjust configuration defaults (TTL, min notional, new flags) and keep schema/tests/docs in sync.
...
- [x] Ship rebuild_positions maintenance utility to repair historical base units.
