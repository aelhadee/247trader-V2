...
| ------ | ----------- | ----------- | -------------- | -------- |
| REQ-AL1 | Alert SLA (60s dedupe, 2m escalation) | ✅ IMPLEMENTED: AlertService with fingerprinting, fixed dedupe window, escalation with severity boost | See docs/ALERT_DEDUPE_ESCALATION.md | MEDIUM |
