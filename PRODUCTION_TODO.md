...
| 🟢 Done | Run PAPER/LIVE read-only smoke to observe `_post_trade_refresh` against real fills. | N/A | PAPER log 2025-11-17 22:44–22:48 UTC shows reconciliation deltas clustered at 0.5–0.8s (max 1.57s), validating wait budget. |
| 🟢 Done | Tune `execution.post_trade_reconcile_wait_seconds` based on observed settle time. | N/A | Policy now sets 0.75s wait (commit 2025-11-17) per log analysis; `_post_trade_refresh` honors policy override with 0–5s clamp. |
